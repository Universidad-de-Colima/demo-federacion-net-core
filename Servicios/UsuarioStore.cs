...
namespace PruebaFederacion.Servicios
{
    public class UsuarioStore : IUserStore<Usuario>, IUserEmailStore<Usuario>, IUserPasswordStore<Usuario>
    {
        ...
        public async Task<Usuario> FindByIdAsync(int userId, CancellationToken cancellationToken)
        {
        ...
        {
            return Task.FromResult(user.ClaveHash);
        }
        ...
        public Task<string> GetUserNameAsync(Usuario user, CancellationToken cancellationToken)
        {
            ...
            return Task.FromResult(user.numTrabajador);
        }
